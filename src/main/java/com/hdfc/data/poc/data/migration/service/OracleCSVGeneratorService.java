...
import com.hdfc.data.poc.data.migration.oracle.repository.GenericOracleRepository;
...
public class OracleCSVGeneratorService {
    ...
    private static final String fileName = "C:\\Users\\Lenovo\\Desktop\\files_for_db\\oracle\\";
    ...
    public void writeOracleDataToCSVFile(String classPath) {
        try {
        ...
        public void run() {
            try {
                if (cls.getAnnotation(Entity.class) != null) {
                    List data = GenericOracleRepository.fetchData(cls.getSimpleName());
